---
citation_key: Mohnke2015TriangularPores
...
pages: 11
text_cache: "_extracted_text\Mohnke2015_e86fcbb01b02efe1.txt"
---

# Mohnke2015TriangularPores

- **题名/文件**：Mohnke2015_triangular_pore_intro! (`Mohnke2015_triangular_pore_intro!.pdf`)
- **建议引用格式**：`[@Mohnke2015TriangularPores]`
- **原始来源**：`NMR Theory and Review\Mohnke2015_triangular_pore_intro!.pdf`
- **入选理由**：理想孔隙几何/三角孔模型与模拟解释，可用于说明几何对 T2 谱的影响。
...
- **可写入报告的引用句式**：短 T2 组分通常支持更强表面弛豫、更小孔径或更高表面积/体积比的解释，但需要结合表面弛豫率和扩散区制判断。 [@Mohnke2015TriangularPores]
...
- **可写入报告的引用句式**：T2 响应携带孔域扩散和边界弛豫共同作用后的有效模态信息，而不只是几何孔径本身。 [@Mohnke2015TriangularPores]
- **证据定位**：见下方证据锚点；若没有页码锚点，则由题名、入选理由和文本关键词归类，正式引用前需复核原 PDF。
